...
- Epoch of Worlds United, which begins when all remaining life in the [Material Plane](../place/plane/prime/material.md) escaped the [Aberrations](../creature/species/aberration/index.md) through the [Six Errant Gates](../item/magic/6-errant-gates.md).
...
- Epoch of Prophecy, which is destined to begin when the [Six Errant Gates](../item/magic/6-errant-gates.md) open again. Whether the eponymous [Prophecy of Shattered Reality](../concept/prophecy/shattered-reality.md) is a prophecy of doom or triumph is yet to be determined.
