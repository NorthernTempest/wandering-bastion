	 ...
	 - [x] The party rolls initiative. They have 3 goals:
		 ...
		 - [x] Minimize the damage
			 ...
			 - Failures:
				 ...
				 - 5: The cathedral will never be rebuilt. The outline of the Themesian gate is one of the more obvious remaining standing structures. At this point, have the party make a DC 14 Int (History) check to recall the [Six Errant Gates](../../../item/magic/6-errant-gates.md) and identify this as one of them. The cathedral collapses. End the 'Lead the people out of the cathedral' skill challenge and enact all remaining failure events in that challenge.
				 - 7: The cathedral has been burned to little more than ashes. The Themesian gate is the one thing that remains standing. At this point, have the party make a DC 12 Int (History) check to recall the [Six Errant Gates](../../../item/magic/6-errant-gates.md) and identify this as one of them.
			 - Turns (init 10):
